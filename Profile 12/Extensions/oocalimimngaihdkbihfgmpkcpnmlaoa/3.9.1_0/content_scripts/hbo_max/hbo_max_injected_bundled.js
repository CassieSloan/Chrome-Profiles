            ...
            if (type === 'seek') {
                ...
                if (props) {
                    const playerState = {
                        ...
                        seriesName: (_b = props._store.getState().ContentManager.fullSeriesTitle) !== null && _b !== void 0 ? _b : props._store.getState().ContentManager.fullTitle,
                        episodeNum: (_c = props._store.getState().ContentManager.numberInSeason) !== null && _c !== void 0 ? _c : props._store.getState().ContentManager.numberInSeries,
